...
CREATE TABLE `requests` (
	...
	`user_id` varchar(36) NOT NULL,
	`stock_id` varchar(36),
	`requested_model_number` varchar(100),
...
ALTER TABLE `stock_locations` ADD CONSTRAINT `stock_locations_location_id_locations_id_fk` FOREIGN KEY (`location_id`) REFERENCES `locations`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
